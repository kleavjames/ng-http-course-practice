...
var AddBookComponent = (function () {
    function AddBookComponent(router, dataService) {
        this.router = router;
...
var AddReaderComponent = (function () {
    function AddReaderComponent(dataService, router) {
        this.dataService = dataService;
        this.router = router;
    }
...
var BooksResolverService = (function () {
    ...
    BooksResolverService.prototype.resolve = function (route, state) {
        return this.dataService.getAllBooks()
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_0_rxjs_operators__["a" /* catchError */])(function (err) { return Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_observable_of__["a" /* of */])(err); }));
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cache_interceptor__ = __webpack_require__("../../../../../src/app/core/cache.interceptor.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_service__ = __webpack_require__("../../../../../src/app/core/data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_core_module_import_guard__ = __webpack_require__("../../../../../src/app/core/module-import-guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__books_resolver_service__ = __webpack_require__("../../../../../src/app/core/books-resolver.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__book_tracker_error_handler_service__ = __webpack_require__("../../../../../src/app/core/book-tracker-error-handler.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__add_header_interceptor__ = __webpack_require__("../../../../../src/app/core/add-header.interceptor.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__log_response_interceptor__ = __webpack_require__("../../../../../src/app/core/log-response.interceptor.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__http_cache_service__ = __webpack_require__("../../../../../src/app/core/http-cache.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CoreModule = (function () {
    function CoreModule(parentModule) {
        Object(__WEBPACK_IMPORTED_MODULE_6_app_core_module_import_guard__["a" /* throwIfAlreadyLoaded */])(parentModule, 'CoreModule');
    }
    CoreModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["u" /* ErrorHandler */], useClass: __WEBPACK_IMPORTED_MODULE_8__book_tracker_error_handler_service__["a" /* BookTrackerErrorHandlerService */] },
                __WEBPACK_IMPORTED_MODULE_7__books_resolver_service__["a" /* BooksResolverService */],
                { provide: __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HTTP_INTERCEPTORS */], useClass: __WEBPACK_IMPORTED_MODULE_9__add_header_interceptor__["a" /* AddHeaderInterceptor */], multi: true },
                { provide: __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HTTP_INTERCEPTORS */], useClass: __WEBPACK_IMPORTED_MODULE_10__log_response_interceptor__["a" /* LogResponseInterceptor */], multi: true },
                __WEBPACK_IMPORTED_MODULE_11__http_cache_service__["a" /* HttpCacheService */],
                { provide: __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HTTP_INTERCEPTORS */], useClass: __WEBPACK_IMPORTED_MODULE_0__cache_interceptor__["a" /* CacheInterceptor */], multi: true },
            ]
        }),
...
var DataService = (function () {
    ...
    DataService.prototype.getAllBooks = function () {
        ...
        return this.http.get("/api/books")
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_operators__["a" /* catchError */])(function (err) { return _this.handleHttpError(err); }));
        // return allBooks;
    };
    ...
    DataService.prototype.getOldBookById = function (id) {
        return this.http.get("/api/books/" + id)
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_operators__["b" /* map */])(function (book) { return ({
            bookTitle: book.title,
            year: book.publicationYear
        }); }), Object(__WEBPACK_IMPORTED_MODULE_5_rxjs_operators__["c" /* tap */])(function (classicBook) { return console.log(classicBook); }));
    };
    ...
    DataService.prototype.handleHttpError = function (error) {
        ...
        return __WEBPACK_IMPORTED_MODULE_6_rxjs_observable_ErrorObservable__["a" /* ErrorObservable */].create(dataError);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_app_models_bookTrackerError__ = __webpack_require__("../../../../../src/app/models/bookTrackerError.ts");
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        if (resolvedData instanceof __WEBPACK_IMPORTED_MODULE_2_app_models_bookTrackerError__["a" /* BookTrackerError */]) {
        ...
        this.dataService.getAllReaders()
            .subscribe(function (readers) { return _this.allReaders = readers; }, function (err) { return console.log(err); });
        this.mostPopularBook = this.dataService.mostPopularBook;
        this.title.setTitle("Book Tracker " + __WEBPACK_IMPORTED_MODULE_1__angular_core__["_8" /* VERSION */].full);
    };
...
var EditBookComponent = (function () {
    function EditBookComponent(router, route, dataService) {
        this.router = router;
        this.route = route;
        this.dataService = dataService;
    }
    EditBookComponent.prototype.ngOnInit = function () {
        var _this = this;
        var bookID = parseInt(this.route.snapshot.params['id'], 16); // 16 radix (hexadecimal)
        ...
        this.dataService.getOldBookById(bookID)
            .subscribe(function (book) { return console.log('Oldbook: ', book); });
    };
    ...
    EditBookComponent.prototype.saveChanges = function () {
        ...
        this.dataService.updateBook(this.selectedBook)
            .subscribe(function () {
            console.log(_this.selectedBook.title + " updated successfully.");
            _this.router.navigate(['/dashboard']);
        }, function (err) { return console.log(err); });
...
var EditReaderComponent = (function () {
    function EditReaderComponent(route, router, dataService, badgeService) {
        this.route = route;
        this.router = router;
        this.dataService = dataService;
    ...
    EditReaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        var readerID = parseInt(this.route.snapshot.params['id'], 16);
        this.dataService.getReaderById(readerID)
            .subscribe(function (reader) {
            _this.selectedReader = reader;
    ...
    EditReaderComponent.prototype.saveChanges = function () {
        ...
        this.dataService.updateReader(this.selectedReader)
            .subscribe(function () {
            console.log(_this.selectedReader.name + " updated successfully.");
            _this.router.navigate(['/dashboard']);
        }, function (err) { return console.log(err); });
